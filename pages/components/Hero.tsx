  ...
  return (
    <section className= 'min-h-screen '>        
      ...
      <div className='text-center p-10 dark:text-white'>
        ...
        <h3 className='text-2xl py-2 md:text-3xl'>Software Engineer and Web Developer</h3>
        <p className='text-md py-5 leading-6 mx-auto text-gray-800 md:text-xl max-w-xl dark:text-gray-200'>
          Looking forward to enhance people`s live by developing softwares. 
          Get to know me and my projects better here!
        </p>
      </div>
      {/* Icons */}
      <div className='text-5xl flex justify-center gap-16 py-3 text-purple-900 hover:drop-shadow-5xl'>
        <a href="https://github.com/Padilha1" className='rounded'
         rel="noopener noreferrer" target={'_blank'}><AiFillGithub className='duration-500
          hover:text-[#EB1212] shadow-lg hover:shadow-[#EB1212]/60'/>
        </a>
        <a href="https://www.linkedin.com/in/padilha--matheus/"
         rel="noopener noreferrer" target='_blank'><AiFillLinkedin className=' duration-500
          hover:text-[#EB1212] shadow-lg  hover:shadow-[#EB1212]/60'/>
        </a>
        <a href="https://twitter.com/Pa__dilha"
         rel="noopener noreferrer" target='_blank'><AiFillTwitterCircle className=' duration-500
          hover:text-[#EB1212] shadow-lg hover:shadow-[#EB1212]/60'/>
        </a>
      </div>
